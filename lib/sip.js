 ...
 * @return {Protocol}
 */
function createProtocol (constructor) {
...
Transaction.prototype._listener = function (msg) {
  ...
  var state = stateCb.call(this, msg.status, msg.method, msg);
 ...
 */
Transaction.prototype.__clientInvite = function (status, method, msgR) {
...
Transaction.prototype.send = function (msg, addr, port, name, cb) {
  ...
  if (this._type && this.state > 0 ||
    ...
    if (cb) cb('Invalid state for sending');
    return;
  }
